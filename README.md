# Solid Contacts Android App

This project is created to show a use-case of how to
use [SolidAndroidClient](https://github.com/pondersource/Android-Solid-Services) library in order to
use [Solid](https://solidproject.org/) in the android ecosystem.
...
install [Android Solid Services app](https://github.com/pondersource/Android-Solid-Services/releases)
and log into your pod.
